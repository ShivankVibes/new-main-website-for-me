...
(function () {
  ...
  // ── "Hello World" Hidden Console Message ─────────────────────────────────────
  console.log('%c👋 Hello, World!', 'color: #3B82F6; font-size: 20px; font-weight: bold;');
  console.log('%cWelcome to the source. Built by Shivank.', 'color: #9CA3AF; font-size: 13px;');
  console.log('%chttps://github.com/shivankvibes', 'color: #8B5CF6; font-size: 12px;');
